...
| **最新週次データ** | 2026年第13週 |
| **最新月次データ** | 2026年3月 |
| **最新データ取得日時** | 2026-04-08 17:32 JST |
| **最終データ更新日時** | 2026-04-07 17:33 JST |
...
|------|-----|
| **総データ件数** | 8,076件 |
| **週次データ期間** | 2000年第1週 - 2026年第13週 |
| **月次データ期間** | 2000年1月 - 2026年3月 |
| **収集週数** | 1,369週 |
| **収集月数** | 315ヶ月 |
| **データ種別数** | 9種類 |
...
| データ種別 | 件数 | データ期間 | 欠損 |
|-----------|------|-----------|------|
| 全数週次 | 1,369件 | 2000年第1週-2026年第13週 | なし |
| 定点週次・保健所別 | 1,369件 | 2000年第1週-2026年第13週 | なし |
| 定点週次・年齢群 | 1,369件 | 2000年第1週-2026年第13週 | なし |
| 定点週次・性別 | 1,356件 | 2000年第14週-2026年第13週 | なし |
| 定点週次・医療圏別 | 1,356件 | 2000年第14週-2026年第13週 | なし |
| 定点月次・年齢群 | 315件 | 2000年1月-2026年3月 | なし |
| 定点月次・医療圏別 | 315件 | 2000年1月-2026年3月 | なし |
| 定点月次・保健所別 | 315件 | 2000年1月-2026年3月 | なし |
| 定点月次・性別 | 312件 | 2000年4月-2026年3月 | なし |
...
<details>
<summary><strong>[csv_format] Inconsistent column count</strong> (8076件)</summary>

```text
notifiable_weekly_2026_13.csv
sentinel_weekly_age_2026_13.csv
sentinel_weekly_gender_2026_13.csv
sentinel_weekly_health_center_2026_13.csv
sentinel_weekly_medical_district_2026_13.csv
notifiable_weekly_2026_12.csv
sentinel_weekly_age_2026_12.csv
sentinel_weekly_gender_2026_12.csv
sentinel_weekly_health_center_2026_12.csv
sentinel_weekly_medical_district_2026_12.csv
notifiable_weekly_2026_11.csv
sentinel_weekly_age_2026_11.csv
sentinel_weekly_gender_2026_11.csv
sentinel_weekly_health_center_2026_11.csv
sentinel_weekly_medical_district_2026_11.csv
notifiable_weekly_2026_10.csv
sentinel_weekly_age_2026_10.csv
sentinel_weekly_gender_2026_10.csv
sentinel_weekly_health_center_2026_10.csv
sentinel_weekly_medical_district_2026_10.csv
notifiable_weekly_2026_09.csv
sentinel_weekly_age_2026_09.csv
sentinel_weekly_gender_2026_09.csv
sentinel_weekly_health_center_2026_09.csv
sentinel_weekly_medical_district_2026_09.csv
notifiable_weekly_2026_08.csv
sentinel_weekly_age_2026_08.csv
sentinel_weekly_gender_2026_08.csv
sentinel_weekly_health_center_2026_08.csv
sentinel_weekly_medical_district_2026_08.csv
notifiable_weekly_2026_07.csv
sentinel_weekly_age_2026_07.csv
sentinel_weekly_gender_2026_07.csv
sentinel_weekly_health_center_2026_07.csv
sentinel_weekly_medical_district_2026_07.csv
notifiable_weekly_2026_06.csv
sentinel_weekly_age_2026_06.csv
sentinel_weekly_gender_2026_06.csv
sentinel_weekly_health_center_2026_06.csv
sentinel_weekly_medical_district_2026_06.csv
notifiable_weekly_2026_05.csv
sentinel_weekly_age_2026_05.csv
sentinel_weekly_gender_2026_05.csv
sentinel_weekly_health_center_2026_05.csv
sentinel_weekly_medical_district_2026_05.csv
notifiable_weekly_2026_04.csv
sentinel_weekly_age_2026_04.csv
sentinel_weekly_gender_2026_04.csv
sentinel_weekly_health_center_2026_04.csv
sentinel_weekly_medical_district_2026_04.csv
... 他8026件
```
...
<details>
<summary><strong>gender_sum_consistency</strong> (1004ファイル, 不整合: 11598件)</summary>
...
sentinel_weekly_medical_district_2025_27.csv (不整合: 13件)
sentinel_weekly_medical_district_2025_26.csv (不整合: 12件)
sentinel_weekly_medical_district_2025_25.csv (不整合: 13件)
sentinel_weekly_medical_district_2025_24.csv (不整合: 11件)
sentinel_weekly_medical_district_2025_23.csv (不整合: 13件)
sentinel_weekly_medical_district_2025_22.csv (不整合: 11件)
sentinel_weekly_medical_district_2025_21.csv (不整合: 12件)
sentinel_weekly_medical_district_2025_20.csv (不整合: 11件)
sentinel_weekly_medical_district_2025_19.csv (不整合: 13件)
sentinel_weekly_medical_district_2025_18.csv (不整合: 13件)
sentinel_weekly_medical_district_2025_17.csv (不整合: 14件)
sentinel_weekly_medical_district_2025_16.csv (不整合: 12件)
... 他954ファイル
```
