...
- 判定: setup-uv の release notes (`chore: update known checksums for X`) または `src/download/checksum/known-checksums.ts` の `x86_64-unknown-linux-gnu-<version>` キー。2026-09-09 時点は v10.0.1 = 0.12.4 まで
